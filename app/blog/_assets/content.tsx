...
export const authors: authorType[] = [
  {
    ...
    job: 'AI MSc Graduate & App Developer',
    description: 'AI graduate passionate about developing mental health technologies to support students and professionals managing anxiety.',
    ...
    content: (
      <>
        ...
        <section>
          ...
          <p className={styles.p}>
            When anxiety strikes, your sympathetic nervous system activates, triggering the &ldquo;fight or flight&rdquo; response. This leads to rapid, shallow breathing, increased heart rate, and heightened stress hormones like cortisol.
          </p>
        </section>
        ...
        <section>
          ...
          <p className={styles.p}>
            Controlled breathing techniques work by stimulating the vagus nerve, which activates your parasympathetic nervous system - your body&apos;s &ldquo;rest and digest&rdquo; mode. This physiological shift:
          </p>
          <ul className={styles.ul}>
